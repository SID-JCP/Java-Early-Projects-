...
public class Rectangle {
    ...
    public Rectangle(JPanel gameCanvas, KeyInput key , MouseInput cursor , MouseClick click)
    {
    ...
    public void update(){
        if (click.mouseDown && cursor.mouseDrag && !KeyInput.rightDrag){
        ...
        if (KeyInput.rightDrag && cursor.mouseDrag){
            drag = 1;
        ...
        if (!cursor.mouseDrag && !KeyInput.rightDrag && drag == 1){
    ...
    public void draw(Graphics g2d){
        ...
        if (!coordinates.isEmpty() && drag == 0)
        {
            for (ArrayList<Integer> coordinate : coordinates) {
                ...
                g2d.fillRoundRect(a, b, c - a, d - b , 15, 15);
        ...
        if (stat == 1 && drag == 0) {
            g2d.setColor(Color.orange);
            g2d.fillRoundRect(click.mouseDownX, click.mouseDownY, cursor.mouseDragX - click.mouseDownX, cursor.mouseDragY - click.mouseDownY ,15,15);
            g2d.setColor(Color.BLUE);
            g2d.drawRoundRect(click.mouseDownX, click.mouseDownY, cursor.mouseDragX - click.mouseDownX, cursor.mouseDragY - click.mouseDownY , 15 ,15);
